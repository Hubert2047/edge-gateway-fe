...
const zhTW: MessageTree = {
    ...
    validation: {
        ...
        phaseMode513Invalid: '513 型智慧電表只能選擇單相或三相平衡',
    ...
    toast: {
        ...
        cloudTestRequired: '請先測試雲端連線成功後再啟用',
...
const en: MessageTree = {
    ...
    meter: {
        ...
        threePhaseBalanced: 'Balanced three-phase',
        voltage: 'Voltage (V)',
    ...
    validation: {
        ...
        phaseMode513Invalid: 'Meter type 513 only supports single-phase or balanced three-phase',
    ...
    toast: {
        ...
        cloudTestRequired: 'Test the cloud connection successfully before enabling it',
    ...
    overview: {
        ...
        neverPolled: 'Data has never been polled from gateway',
        notAvailable: '—',
        noGateways: 'No local gateways configured',
        noCloudTargets: 'No cloud targets configured',
