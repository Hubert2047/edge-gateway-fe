...
const messages: Record<Locale, Messages> = {
    'zh-TW': {
        ...
        'nav.processControl': '製程管制', 'nav.processRules': '製程規則', 'nav.users': '使用者管理', 'nav.settings': '系統設定',
        ...
        'users.title': '使用者管理', 'users.count': '位使用者', 'users.username': '使用者名稱', 'users.password': '密碼',
        'users.role': '角色', 'users.status': '狀態', 'users.admin': '管理員', 'users.user': '使用者', 'users.viewer': '檢視者', 'users.readonly': '唯讀',
        'users.empty': '尚未建立任何使用者', 'users.addTitle': '新增使用者', 'users.required': '請輸入使用者名稱與密碼',
        'users.created': '使用者建立成功', 'users.createFailed': '使用者建立失敗', 'users.updateFailed': '使用者更新失敗',
        'users.deleted': '使用者刪除成功', 'users.deleteFailed': '使用者刪除失敗', 'users.confirmDelete': '確定要刪除「{username}」嗎？',
        'users.passwordApiNote': '管理員可以重設既有使用者的密碼；使用者名稱目前不可修改。', 'users.resetPassword': '重設密碼',
        'users.resetPasswordDescription': '請輸入「{username}」的新密碼。', 'users.newPassword': '新密碼', 'users.passwordRequired': '請輸入新密碼',
        'users.passwordReset': '密碼重設成功', 'users.passwordResetFailed': '密碼重設失敗',
        'users.usernameUpdated': '使用者名稱更新成功', 'users.protected': '系統管理員',
    },
    en: {
        ...
        'settings.save': 'Save settings', 'settings.saved': 'Language preference saved', 'nav.users': 'User management',
        ...
        'users.title': 'User management', 'users.count': 'users', 'users.username': 'Username', 'users.password': 'Password',
        'users.role': 'Role', 'users.status': 'Status', 'users.admin': 'Admin', 'users.user': 'User', 'users.viewer': 'Viewer', 'users.readonly': 'Read-only',
        'users.empty': 'No users configured', 'users.addTitle': 'Add user', 'users.required': 'Enter a username and password',
        'users.created': 'User created', 'users.createFailed': 'Failed to create user', 'users.updateFailed': 'Failed to update user',
        'users.deleted': 'User deleted', 'users.deleteFailed': 'Failed to delete user', 'users.confirmDelete': 'Delete “{username}”?',
        'users.passwordApiNote': 'Admins can reset existing passwords; usernames cannot currently be edited.', 'users.resetPassword': 'Reset password',
        'users.resetPasswordDescription': 'Enter a new password for “{username}”.', 'users.newPassword': 'New password', 'users.passwordRequired': 'Enter a new password',
        'users.passwordReset': 'Password reset successfully', 'users.passwordResetFailed': 'Failed to reset password',
        'users.usernameUpdated': 'Username updated', 'users.protected': 'System administrator',
    },
}
